...
from scripts.eval.webtext_dataset import WebTextPretokenizedDataset
...
class ModelArguments:
    ...
    controllable_model: Optional[str] = field(
        default=None,
        metadata={"help": "Use a controllable model for eval"},
    )
...
class DataTrainingArguments:
    ...
    train_data_file: Optional[str] = field(
        default=None, metadata={"help": "The input training data_processing file (a text file)."}
    )
    eval_data_file: Optional[str] = field(
        default=None,
        metadata={"help": "An optional input eval data_processing file to evaluate the perplexity on (a text file)."},
    )
...
def main():
    ...
    if data_args.eval_data_file is None:
        raise ValueError(
            "Cannot do eval without an eval data_processing file."
        )
    ...
    if model_args.model_name_or_path:
        ...
        if controllable_model and controllable_model.startswith('affect-gpt2'):
            logger.info("Using AffectLM for eval")
